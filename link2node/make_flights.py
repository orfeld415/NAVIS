...
# Load new csv 
data = pd.read_csv(f"{DIR}/Flights.csv")
...
data.to_csv(f"{DIR}/tgbn-flights_edgelist.csv", index=False)
...
# Save labels
aggregated.to_csv(f"{DIR}/tgbn-flights_node_labels.csv", index=False)
